...
class RollingCurl
{
   ...
   private $completedRequestCount = 0;
    ...
    public function __construct() {
        // Initialize userAgents here with dynamic values
        $this->userAgents = [
            'Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.' . $this->generateRandomVersion() . ' Safari/537.36',
            'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.' . $this->generateRandomVersion() . ' Safari/537.36',
            'Mozilla/5.0 (Macintosh; Intel Mac OS X 11_0_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/118.0.' . $this->generateRandomVersion() . ' Safari/537.36',
            'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.' . $this->generateRandomVersion() . ' Safari/537.36',
            'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.' . $this->generateRandomVersion() . ' Safari/537.36',
            'Mozilla/5.0 (Windows NT 10.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.' . $this->generateRandomVersion() . ' Safari/537.36'
        ];
        $randomins = array_rand($this->userAgents); // Get a random index
        $this->options[CURLOPT_USERAGENT] = $this->userAgents[$randomins]; // Set the user agent
    }
